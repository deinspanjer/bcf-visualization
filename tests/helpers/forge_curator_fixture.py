...
def _roll_fact(chapter_num: str, *, cp_start: int) -> dict:
    ...
    return {
        ...
        "source_row_index": 1,
        "roll_ordinal": int(chapter_num),
        "roll_label": f"R{int(chapter_num)}",
        "chapter_ordinal": 1,
        "chapter_label": "C1",
        "predicted_ordinal": int(chapter_num),
        "predicted_label": f"P{int(chapter_num)}",
        "source_ordinal": int(chapter_num),
        "source_label": f"S{int(chapter_num)}",
        ...
        "source_roll_label": f"Roll {int(chapter_num)}",
