...
- [ ] 01-02-PLAN.md — Mobile CSS foundation (web/mobile.css: touch-action surfaces, svh/dvh, safe-area insets) + visibilitychange pause (D-02, mobile-only)
- [ ] 01-03-PLAN.md — Scripted §0.5 desktop smoke test (tests/test_desktop_smoke.py, D-10 gate artifact)

**Wave 3** *(blocked on Wave 2 completion)*

- [ ] 01-04-PLAN.md — Full verification run + §5 Phase A gate review checkpoint with Dre
